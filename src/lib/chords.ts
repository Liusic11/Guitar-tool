...
export const CHORD_TYPES: ChordType[] = [
  {
    ...
    theory:
      '「三和弦」= 从根音出发，每隔一个音叠一层：根音 → 三音 → 五音，叠了两层三度，所以叫「三」和弦。大三和弦的三音离根音是「大三度」（4 个半音），听感亮、稳，像你说话时语气往上的那个字。',
    songs: '流行歌的绝对主角。C→Am→F→G 这种进行里，C 和 F 都是大三；你听《Hotel California》开头、《平凡之路》副歌里都有它撑着。',
    remember: '记法：大三 = 「亮」。大调的 I 级、IV 级都是它。',
    ear: '耳朵练习：弹 C 大三，记住这个「晴天的亮」；下一关去对比 Cm，先听出情绪差别，再去找那个暗下去的三音。',
  },
  {
    id: 'min',
    label: '小三和弦',
    ...
    theory:
      '叠法完全一样，只是三音离根音只差「小三度」（3 个半音），整体就暗下来了。同一个根音，大三很亮、小三就忧伤——差别全在那个三音，记住这一根弦你就懂了大小调。',
    songs: '小调的魂：Am、Em、Dm 在流行/摇滚里到处都是。《Let It Be》里有 Am，《Bad Moon Rising》用小调营造那股不安。',
    remember: '记法：小三 = 「暗」。公式 0·3·7，比大三少了那 1 个半音（4→3）。',
    ear: '耳朵练习：弹 C 大三再弹 Cm，闭眼听——哪个音「沉」下去了？就是三音从 E 降到了 E♭（降半音）。',
  },
  {
    id: 'dom7',
    label: '属七和弦',
    ...
    theory:
      '在三和弦上「再叠一层三度」就到了七音 → 4 个音，所以叫「七」和弦。属七 = 大三 + 小七度（♭7）。那个 ♭7 制造一股「想解决」的拉力，是 blues 的发动机——它不停在说「跟我走，还没完」。',
    songs: 'blues 的 12 小节里每个和弦几乎都是属七；funk 的招牌。《Sweet Home Chicago》《Superstition》(Stevie Wonder) 的 riff 全是它。',
    remember: '记法：属七 = 「想解决」。公式 0·4·7·10，盯住那个 ♭7（10）。',
  ...
  },
  {
    ...
    theory:
      '小三和弦 + 小七度。比属七温柔太多了，没有那种急着解决的冲动，松松的、能一直 loop。jazz 和 soul 里几乎每一小节都有它，是「放松」的声音。',
  ...
  },
  {
    ...
    theory:
      '大三和弦 + 大七度（自然七度）。那个大七度带来一种温柔悬停感——美好但不想结束，是 city pop、bossa、现代流行的招牌色彩。',
  ...
  },
  {
    ...
    theory:
      '把小七和弦的五音降半音（♭5），就得到半减七。之所以叫「半减」，是因为它只把五度减了，七度还是小七——所以和「全减七(dim7)」区分开。它常出现在 jazz 进行里，负责把气氛往下拽一点。',
  ...
  },
  {
    ...
    usage: '过渡 / 离调；恐怖、悬疑配乐',
    theory:
      '四个音全是小三度（0·3·6·9），完全对称。妙处在于：任意一个音都能当根音，所以一个 dim7 指法能「转位」出 4 个不同根的减七。它极不稳定，最适合当过渡桥或离调的踏板。',
  ...
  },
  {
    ...
    usage: '经过和弦；古典 / 爵士过渡',
    theory:
      '三度叠置里三音、五音都用小三度。比小三和弦还暗一截，常当「踏板」踩向稳定和弦——你听到它就知道「要转弯了」。',
  ...
  },
  {
    ...
    usage: '转向关系远调；电影配乐',
    theory:
      '三音、五音都用大三度（0·4·8），对称结构。听感像「悬在半空、上不去下不来」，常用来制造离调或梦幻感，很适合电影里那种「要变天了」的瞬间。',
